...
public class MatchService {
    ...
    static {
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Administrator\\Desktop\\matrimony_Backend\\Vivah_v1.0.1\\Vivaha_v1.0.0-main\\src\\main\\java\\com\\example\\vivaha_v100\\service\\MATRIX1.csv"));
            String s1;
            String s2;
            int i = 0;
